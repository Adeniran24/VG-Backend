...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("SERVER=localhost;PORT=3306;DATABASE=receptdb;USER=root;PASSWORD=;", MySqlServerVersion.AutoDetect("SERVER=localhost;PORT=3306;DATABASE=receptdb;USER=root;PASSWORD=;"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Recept>(entity =>
        {
            ...
            entity.HasIndex(e => e.NehezsegId, "fk_recept_nehezseg");

            entity.HasIndex(e => e.SzakacsId, "fk_recept_szakacs");
        ...
        modelBuilder.Entity<Recepthozzavalo>(entity =>
        {
            ...
            entity.HasIndex(e => e.HozzavaloId, "fk_rh_hozzavalo");
